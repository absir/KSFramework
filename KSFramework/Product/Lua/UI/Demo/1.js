...
try {
    var idb = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, testRequest = idb.open("/idbfs-test");
...
LoadCompressedFile(Module.memUrl, function (e) {
    ...
    return function e(t, n, o) {
        ...
        7: [function (e, t, n) {
            ...
            t.exports = function (e, t) {
                ...
                e:do {
                    ...
                    t:for (; ;) {
                        if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _)D[s++] = 65535 & y; else {
                            if (!(16 & _)) {
                                if (0 === (64 & _)) {
                                    y = b[(65535 & y) + (m & (1 << _) - 1)];
                                    continue t
        ...
        8: [function (e, t, n) {
            ...
            function f(e, t) {
                var n, i, a, r, s, d, l, f, h, p, m, w, pe, me, we, be, ge, ve, ke, ye, _e, Se, xe, Me, Ce = 0, Ee = new b.Buf8(4), De = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                ...
                e:for (; ;)switch (n.mode) {
                    ...
                    case ee:
                        for (; n.have < n.nlen + n.ndist;) {
                            ...
                            if (16 > ge)f >>>= we, h -= we, n.lens[n.have++] = ge; else {
                                if (16 === ge) {
                                    for (Me = we + 2; Me > h;) {
                                        if (0 === d)break e;
                                        d--, f += i[r++] << h, h += 8
            ...
            var m, w, b = e("../utils/common"), g = e("./adler32"), v = e("./crc32"), k = e("./inffast"), y = e("./inftrees"), _ = 0, S = 1, x = 2, M = 4, C = 5, E = 6, D = 0, R = 1, I = 2, F = -2, L = -3, A = -4, B = -5, O = 8, U = 1, N = 2, z = 3, T = 4, P = 5, Z = 6, q = 7, G = 8, H = 9, j = 10, J = 11, W = 12, K = 13, Y = 14, X = 15, V = 16, Q = 17, $ = 18, ee = 19, te = 20, ne = 21, oe = 22, ie = 23, ae = 24, re = 25, se = 26, de = 27, le = 28, ue = 29, ce = 30, fe = 31, he = 32, pe = 852, me = 592, we = 15, be = we, ge = !0;
        ...
        9: [function (e, t, n) {
            "use strict";
            var o = e("../utils/common"), i = 15, a = 852, r = 592, s = 0, d = 1, l = 2, u = [3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31, 35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258, 0, 0], c = [16, 16, 16, 16, 16, 16, 16, 16, 17, 17, 17, 17, 18, 18, 18, 18, 19, 19, 19, 19, 20, 20, 20, 20, 21, 21, 21, 21, 16, 72, 78], f = [1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193, 257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145, 8193, 12289, 16385, 24577, 0, 0], h = [16, 16, 16, 16, 17, 17, 18, 18, 19, 19, 20, 20, 21, 21, 22, 22, 23, 23, 24, 24, 25, 25, 26, 26, 27, 27, 28, 28, 29, 29, 64, 64];
            t.exports = function (e, t, n, p, m, w, b, g) {
                var v, k, y, _, S, x, M, C, E, D = g.bits, R = 0, I = 0, F = 0, L = 0, A = 0, B = 0, O = 0, U = 0, N = 0, z = 0, T = null, P = 0, Z = new o.Buf16(i + 1), q = new o.Buf16(i + 1), G = null, H = 0;
                for (R = 0; i >= R; R++)Z[R] = 0;
                for (I = 0; p > I; I++)Z[t[n + I]]++;
                for (A = D, L = i; L >= 1 && 0 === Z[L]; L--);
                if (A > L && (A = L), 0 === L)return m[w++] = 20971520, m[w++] = 20971520, g.bits = 1, 0;
                for (F = 1; L > F && 0 === Z[F]; F++);
                for (F > A && (A = F), U = 1, R = 1; i >= R; R++)if (U <<= 1, U -= Z[R], 0 > U)return -1;
        ...
        "/lib/inflate.js": [function (e, t, n) {
            ...
            var a = e("./zlib/inflate.js"), r = e("./utils/common"), s = e("./utils/strings"), d = e("./zlib/constants"), l = e("./zlib/messages"), u = e("./zlib/zstream"), c = e("./zlib/gzheader"), f = Object.prototype.toString, h = function (e) {
...
"undefined" == typeof Module && (Module = eval("(function() { try { return Module || {} } catch(e) { return {} } })()")), Module.expectedDataFileDownloads || (Module.expectedDataFileDownloads = 0, Module.finishedDataFileDownloads = 0), Module.expectedDataFileDownloads++, function () {
    var e = function (e) {
        ...
        function n() {
            ...
            }, new t(0, 21746803, 0, 0).open("GET", "/data.unity3d"), new t(21746803, 21748077, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(21748077, 21761442, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(21761442, 26520662, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(26520662, 27395634, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(27395634, 27423259, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_shinchan.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {fromCache: !1}, d ? (n(d), d = null) : l = n
        }
        ...
        var i = "shinchan.data", a = "shinchan.data";
        ...
        var r = "function" == typeof Module.locateFile ? Module.locateFile(a) : (Module.filePackagePrefixURL || "") + a, s = 27423259, d = null, l = null;
